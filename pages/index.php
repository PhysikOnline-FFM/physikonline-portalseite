<!-- Carousel
	...
	<div class="item active dark">
          <img class="first-slide" src="/images/osz-bei-nacht.jpg" alt="Otto-Stern-Zentrum im Dunkeln">
            <div class="caption right dark-bg">
		<div class="content">
		      <h2>Studierende machen eLearning</h2>
		      <p>PhysikOnline löst Probleme, die Studierende stören.</p>
		</div>
            </div>
        </div>
        <div class="item">
          <img src="/images/ilias-hoersaal.jpg" alt="ILIAS-Screenshot">
            <div class="caption right dark-bg">
		<div class="content">
        ...
        <div class="item">
          <img src="/images/cloud-macbook-pokal.jpg" alt="POKAL in der Cloud">
        ...
        <div class="item">
          <img src="/images/tinygu-kuerzen.jpg" alt="Vorlesungsverzeichnis-Screenshot">
            <div class="caption right dark-bg">
		<div class="content">
		      <h1>Goethe.link</h1>
        ...
        <div class="item">
          <img src="/images/riedberg-von-oben.jpg" alt="Fotografie vom Campus Riedberg">
        ...
        <div class="item">
          <img class="first-slide" src="/images/foto-physikgebaeude.jpg" alt="Physikgebäude">
            <div class="caption right dark-bg">
		<div class="content">
		      <h2>Schaltzentrale</h2>
		      <p>PhysikOnline hat seinen Ursprung im Institut für theoretische Physik.</p>
		</div>
            </div>
        </div>
        <div class="item">
          <img class="first-slide" src="/images/physikonline-cube-bokeh.jpg" alt="Kunst mit dem PhysikOnline-Logo">
            <div class="caption left">
		<div class="content">
		      <h2>eLearning seit 2007</h2>
		      <p>PhysikOnline wurde 2007 im Rahmen von megadigitale gegründet.</p>
		</div>
            </div>
        </div>
        <div class="item">
          <img class="first-slide" src="/images/body-of-knowledge.jpg" alt="Body of Knowledge, Campus Westend">
            <div class="caption left">
		<div class="content">
		      <h2>Idealen verpflichtet</h2>
		      <p>PhysikOnline <a href="http://github.com/PhysikOnline-FFM/">schreibt</a> Open-Source. Unsere Organisation ist <a href="https://elearning.physik.uni-frankfurt.de/projekt">transparent</a>.</p>
		</div>
            </div>
        </div>
      </div>
	...
	<div class="col-md-4">
		<a href="http://elearning.physik.uni-frankfurt.de/go/impressum" class="metro metro-1">
			<img class="img-circle" src="/images/anonymous-2.png" alt="" height="140" width="140">
			<h2>Deine Idee?</h2>
			<p>Wenn auch du ein kreativer Kopf bist, der gerne neue Dinge anpackt, oder dich unsere Projekte angesprochen haben und uns unterstüzen möchtest, dann komm' doch mal vorbei oder schreib uns!</p>
		</a>
        </div><!-- /.col-md-4 -->
      </div><!-- /.row 2-->
